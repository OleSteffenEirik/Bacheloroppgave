    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        $cartTable.append(
          ...
          // browser spesifikk kode slik nettstedet støtter IE9 
          ' <!--[if IE]><td class="col-1 align-middle" title="Quantity"><input id="numberQ" type="text" min="1" style="width:40px;" class="<![endif]--><!--[if !IE]><!--><td class="col-1 align-middle" title="Quantity"><input id="numberQ" type="number" min="1" style="width:40px;" class="<!--<![endif]--><!-->' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
            ...
            '</tr>' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td class="col-1 align-middle" title="Remove from Cart" class="text-center"><a href="javascript:void(0);" class="btn btn-xs btn-rounded my-0 btn-danger ' + classProductRemove + '"><i class="fas fa-times"></i></a></td>' +
          '</tr>'
        );
      });
