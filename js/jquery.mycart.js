    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        $cartTable.append(
          ...
          '<!--[if IE]><td class="col-1 align-middle" title="Quantity"><input id="numberQ" type="text" min="1" style="width:40px;" class="<![endif]--><!--[if !IE]> --> <td class="col-1 align-middle" title="Quantity"><input id="numberQ" type="number" min="1" style="width:40px;" class="<!-- <![endif]-->' 
